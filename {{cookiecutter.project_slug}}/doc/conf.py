...
latex_documents = [
  (master_doc, '{{ cookiecutter.app_name }}.tex', '{{ cookiecutter.app_name }} Documentation',
...
man_pages = [
    (master_doc, 'projectname', '{{ cookiecutter.app_name }} Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, '{{ cookiecutter.app_name }}', '{{ cookiecutter.app_name }} Documentation',

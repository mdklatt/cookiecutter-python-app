...
latex_documents = [
    (master_doc, "{{cookiecutter.app_name}}.tex", "{{cookiecutter.app_name}} Documentation", "{{cookiecutter.author_name}}", "manual"),
]
...
man_pages = [(master_doc, "projectname", "{{cookiecutter.app_name}} Documentation", [author], 1)]
